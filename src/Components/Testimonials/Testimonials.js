    ...
    <div className="testimonialSection">
      <div className="testimonialHolder">
        <div className="testimonialHeader">
          <p>Trust forms the bedrock of the digital realm</p>
        </div>
      </div>
      <div className="testimonialHolder">
        <div className="testimonialDesc">
          <p>
            Don't Just Take Our Word For It- Discover What Our Clients Are
            Raving About!
          </p>
        </div>
      </div>
